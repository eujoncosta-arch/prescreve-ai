...
| 5 | Rastreabilidade de referências científicas | 🟡 | 🟢 (139 c/ diretriz, 104 c/ evidência — sourced) |
...
| 5 | Enriquecer `references[]` (diretriz/DOI/evidência) | 5 | ✅ classes principais cobertas — **139/358 (39%)** com diretriz e **104 (29%)** com nível+classe de evidência, sourced (ESC/ESH/EAS/ADA/ATA/GINA/GOLD/NICE/APA/CANMAT/ILAE/ACG/IDSA). Restam variantes de contexto e agentes de nicho (contínuo) |
