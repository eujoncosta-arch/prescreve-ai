...
const NOS_BASE: NoGrafo[] = [
  ...
  { id: 'anlodipino',      tipo: 'medicamento', label: 'Anlodipino',      metadados: { classe: 'BCC', atc: 'C08CA01' } },
  ...
  { id: 'sacubitril_valsartanasartana', tipo: 'medicamento', label: 'Sacubitril/Valsartana', metadados: { classe: 'ARNI', atc: 'C09DX04' } },
  ...
  { id: 'fluticasona_salmeterol', tipo: 'medicamento', label: 'Fluticasona/Salmeterol', metadados: { classe: 'ICS+LABA', atc: 'R03AK06' } },
  { id: 'eplerenona',      tipo: 'medicamento', label: 'Eplerenona',      metadados: { classe: 'ARM', atc: 'C03DA04' } },
  ...
  // Estudos
  { id: 'empa_reg',    tipo: 'estudo', label: 'EMPA-REG OUTCOME', metadados: { doi: '10.1056/NEJMoa1504720', nnt: 39, rrr_cv: 0.38,  evidence_db_id: 'empa-reg' } },
  { id: 'dapa_hf',    tipo: 'estudo', label: 'DAPA-HF',          metadados: { doi: '10.1056/NEJMoa1911303', nnt: 21, rrr_ic: 0.26,  evidence_db_id: 'dapa-hf' } },
  { id: 'paradigm',   tipo: 'estudo', label: 'PARADIGM-HF',      metadados: { doi: '10.1056/NEJMoa1409077', nnt: 18,               evidence_db_id: 'paradigm-hf' } },
  { id: 'hope_study', tipo: 'estudo', label: 'HOPE Study',       metadados: { doi: '10.1056/NEJM200001203420301', nnt: 26,          evidence_db_id: 'hope' } },
  { id: 'facet_study',tipo: 'estudo', label: 'FACET (ICS+LABA vs. ICS)', metadados: { nnt: 15, rrr_exacerbacao: 0.44 } },
  { id: 'ukpds',      tipo: 'estudo', label: 'UKPDS',            metadados: { doi: '10.1016/S0140-6736(98)07019-6', nnt: 12,       evidence_db_id: 'ukpds34' } },
  { id: 'accord',     tipo: 'estudo', label: 'ACCORD',           metadados: { doi: '10.1056/NEJMoa0802743' } },
  { id: 'sprint',     tipo: 'estudo', label: 'SPRINT',           metadados: { doi: '10.1056/NEJMoa1511939', nnt: 61, descricao: 'PA alvo < 120 mmHg vs < 140 mmHg — redução 25% MACE em HAS sem DM', evidence_db_id: 'sprint' } },
  { id: 'rales',      tipo: 'estudo', label: 'RALES',            metadados: { doi: '10.1056/NEJM199909023411001', nnt: 9, descricao: 'Espironolactona em IC-FEr grave — redução 30% mortalidade',    evidence_db_id: 'rales' } },
  { id: 'emphasis_hf',tipo: 'estudo', label: 'EMPHASIS-HF',      metadados: { doi: '10.1056/NEJMoa1009492', nnt: 14, descricao: 'Eplerenona em IC-FEr leve-moderada — redução 37% desfecho primário', evidence_db_id: 'emphasis-hf' } },
...
const ARESTAS_BASE: ArestaGrafo[] = [
  ...
  { id: 'e12', origem: 'I10',  destino: 'anlodipino',     tipo: 'DIAGNOSTICO_MEDICAMENTO', peso: 4, evidencia: 'A' },
  ...
  { id: 'e17', origem: 'I50',  destino: 'sacubitril_valsartana', tipo: 'DIAGNOSTICO_MEDICAMENTO', peso: 5, evidencia: 'A' },
  ...
  { id: 'e21', origem: 'J45',  destino: 'fluticasona_salmeterol',tipo: 'DIAGNOSTICO_MEDICAMENTO', peso: 5, evidencia: 'A' },
  ...
  { id: 'e34', origem: 'sacubitril_valsartana',  destino: 'mec_arni',    tipo: 'MEDICAMENTO_MECANISMO', peso: 5 },
  ...
  { id: 'e37', origem: 'fluticasona_salmeterol', destino: 'mec_ics',     tipo: 'MEDICAMENTO_MECANISMO', peso: 5 },
  ...
  { id: 'e42', origem: 'sacubitril_valsartana',  destino: 'paradigm',   tipo: 'MEDICAMENTO_ESTUDO', peso: 5, doi: '10.1056/NEJMoa1409077', nnt: 18 },
  { id: 'e43', origem: 'ramipril',        destino: 'hope_study', tipo: 'MEDICAMENTO_ESTUDO', peso: 4, doi: '10.1056/NEJM200001203420301', nnt: 26 },
  { id: 'e44', origem: 'fluticasona_salmeterol', destino: 'facet_study', tipo: 'MEDICAMENTO_ESTUDO', peso: 4, nnt: 15 },
  ...
  { id: 'e62', origem: 'sacubitril_valsartana',  destino: 'marca_entresto',  tipo: 'MEDICAMENTO_MARCA', peso: 3 },
  { id: 'e63', origem: 'fluticasona_salmeterol', destino: 'marca_lugano', tipo: 'MEDICAMENTO_MARCA', peso: 3 },
