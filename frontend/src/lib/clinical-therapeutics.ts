  ...
  dm2: {
    farmacologico: [
      sug({
        ...
        alternativas: ['Empagliflozina 10 mg (DM2 + DCV estabelecida ou DRC)', 'Sitagliptina 100 mg (tolerância GI ruim)', 'Liraglutida 1,2 mg SC/dia (DM2 + obesidade + DCV)'],
  ...
  icc: {
    farmacologico: [
      sug({
        ...
        indicacao: 'ICC com FEVE reduzida (< 40%) — reduz mortalidade e hospitalização',
      ...
      sug({
        ...
        indicacao: 'ICC — alívio de congestão (edema, ortopneia, dispneia)',
