...
export const EUROFARMA_CATALOG: ProdutoComercial[] = [
...

  {
    ...
    molecula: 'Budesonida',
    nome_comercial: 'Noex®',
    classe_terapeutica: 'Corticosteroide de uso nasal',
    cids_aprovados: ['J30', 'J33'],
    apresentacoes: [
    ...
    posologia_aprovada: 'Rinite (32/64 mcg/dose): 256 mcg/dia — 32 mcg/dose: 4 aplicações em cada narina, ou 64 mcg/dose: 2 aplicações em cada narina, 1x/dia ou dividido. Pólipo nasal (50/100 mcg/dose): 400 mcg/dia. Uso NASAL.',
    contraindicacoes_bula: ['Hipersensibilidade à budesonida', 'Infecção nasal não tratada'],
...

  {
    ...
    classe_terapeutica: 'Corticosteroide de uso nasal',
    cids_aprovados: ['J30', 'J33', 'J01'],
    apresentacoes: [
      { concentracao: '50 mcg/dose', forma_farmaceutica: 'spray', embalagem: 'Frasco 17,5 mL (120 acionamentos)' },
    ],
    posologia_aprovada: 'Rinite alérgica: 2 aplicações (50 mcg cada) em cada narina 1x/dia (200 mcg/dia); manutenção 1 aplicação/narina 1x/dia. Pólipo nasal/rinossinusite: 2 aplicações/narina 1–2x/dia. Uso NASAL.',
    contraindicacoes_bula: ['Hipersensibilidade à mometasona', 'Infecção nasal não tratada', 'Cirurgia/trauma nasal recente'],
    advertencias_principais: ['Candidíase oral — lavar boca após uso', 'Não substituir corticosteroide sistêmico abruptamente', 'Monitorar crescimento em crianças'],
