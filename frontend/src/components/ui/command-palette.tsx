...
const COMMANDS: CommandItem[] = [
  ...
  { id: 'eurofarma',      label: 'Eurofarma Dashboard',    href: '/eurofarma',           icon: Building2,       group: 'Institucional', keywords: ['eurofarma','dashboard','institucional','kpi','marcas','especialidades','classes','evidencias','diretrizes','cobertura','prescricoes','cenarios','vast','holmes','glif','pisa','pietra','piemonte','lugano','zart','desve','afetus','don','attenze','antara','gaba'] },
